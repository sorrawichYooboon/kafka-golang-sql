...
func NewEventService(accountRepo repositories.IAccountRepository) IEventService {
	return eventService{accountRepo}
}

func (obj eventService) Handle(topic string, eventBytes []byte) {
	switch topic {
